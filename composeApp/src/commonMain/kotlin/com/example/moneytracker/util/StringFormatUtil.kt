 ...
 */
internal fun Double.formatDecimalPlaces(digits: Int): String {
    if (digits <= 0) {
    ...
    // Use abs to handle negative numbers correctly for the minor part calculation
    val minor = kotlin.math.abs(rounded % factor.toInt())
